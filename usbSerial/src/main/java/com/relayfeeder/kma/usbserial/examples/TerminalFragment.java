...
public class TerminalFragment extends Fragment implements SerialInputOutputManager.Listener {
    ...
    String led11, led22, led33, led44, led55, led66, led77, led88, filer11, filer22;
    String finalvar = "$R2BBBBBBBB";
    String finalfiler = "$F1BB";
                    ...
                    private void receive(byte[] data) {
                      ...
                      if (separated.substring(2, 4).equals("46")) {
                        if (separated.length() > 17) {
                          if (separated.substring(10, 12).equals("4C")) {
                            ...
                            switchfider1.setAlpha(0.5 f);
                            switchfider2.setAlpha(0.5 f);
                          } else {
                            Switch switchfider1 = (Switch) getView().findViewById(R.id.switchfiler1);
                            Switch switchfider2 = (Switch) getView().findViewById(R.id.switchfiler2);
                            Button f1_button = (Button) getView().findViewById(R.id.power);
                            ...
                            switchfider1.setAlpha(1 f);
                            switchfider2.setAlpha(1 f);
                      ...
                      if (separated.substring(2, 4).equals("52")) {
                        if (separated.length() > 19) {
                          if (separated.substring(6, 8).equals("41")) {
                          ...
                          if (separated.substring(8, 10).equals("41")) {
                          ...
                          if (separated.substring(10, 12).equals("41")) {
                          ...
                          if (separated.substring(12, 14).equals("41")) {
                          ...
                          if (separated.substring(14, 16).equals("41")) {
                          ...
                          if (separated.substring(16, 18).equals("41")) {
                          ...
                          if (separated.substring(18, 20).equals("41")) {
                          ...
                          if (separated.substring(20, 22).equals("41")) {
                            ...
                            r8_button.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_cancel_white_24dp, 0, 0, 0);

                          } else {
                            Button r8_button = (Button) getView().findViewById(R.id.button8);
                            r8_button.setText("Relay-8 opend");
                            r8_button.setBackgroundResource(R.color.colorgreen);
                            r8_button.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_check_circle_white_24dp, 0, 0, 0);
                          }
